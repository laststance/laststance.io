...
describe('buildPageList', () => {
  test('returns every page directly when totalPages ≤ 7 (no ellipsis needed)', () => {
  ...
  test('returns [1..7] when totalPages equals the threshold of 7', () => {
  ...
  test('places only a trailing ellipsis when current is near the start', () => {
  ...
  test('shows both ellipses with window around current in the middle of the range', () => {
  ...
  test('places only a leading ellipsis when current is on the last page', () => {
  ...
  test('returns a single-entry list when totalPages is 1', () => {
