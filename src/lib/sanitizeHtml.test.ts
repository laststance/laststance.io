...
describe('sanitizeHtml', () => {
  describe('basic functionality', () => {
    ...
    test('should return empty string for null/undefined-like falsy input', () => {
    ...
    test('should preserve anchor tags with safe hrefs', () => {
  ...
  describe('script tag removal', () => {
    test('should remove inline script tags', () => {
    ...
    test('should remove script tags with src attribute', () => {
  ...
  describe('event handler removal', () => {
    ...
    test('should handle case variations of event handlers', () => {
    ...
    test('should remove all on* prefixed attributes', () => {
      const html =
  ...
  describe('javascript: URL removal', () => {
    test('should remove javascript: URLs from href', () => {
    ...
    test('should remove javascript: URLs from src', () => {
      const html = '<img src="javascript:alert(\'xss\')">'
      const result = sanitizeHtml(html)
      expect(result).not.toContain('javascript:')
    })

    test('should handle javascript: URLs with whitespace', () => {
      const html = '<a href="  javascript:alert(\'xss\')">Link</a>'
      const result = sanitizeHtml(html)
      expect(result).not.toContain('javascript:')
    })

    test('should handle case variations of javascript:', () => {
      const html = '<a href="JAVASCRIPT:alert(\'xss\')">Link</a>'
      const result = sanitizeHtml(html)
      expect(result).not.toContain('javascript:')
      expect(result).not.toContain('JAVASCRIPT:')
    ...
    test('should preserve data: URLs (not javascript:)', () => {
      const html = '<img src="data:image/png;base64,iVBORw0KGgo=">'
      const result = sanitizeHtml(html)
      expect(result).toContain('data:image/png')
    })

    test('should preserve mailto: URLs', () => {
      const html = '<a href="mailto:test@example.com">Email</a>'
      const result = sanitizeHtml(html)
      expect(result).toContain('mailto:')
    })

    test('should preserve tel: URLs', () => {
  ...
  describe('complex XSS attack vectors', () => {
    ...
    test('should handle body onload XSS', () => {
      const html = '<body onload="alert(\'xss\')">Content</body>'
      const result = sanitizeHtml(html)
      expect(result).not.toContain('onload')
    })

    test('should handle img tag XSS with onerror', () => {
    ...
    test('should handle encoded payloads in attributes', () => {
  ...
  describe('GitHub feed content scenarios', () => {
    test('should sanitize typical GitHub feed HTML', () => {
      const githubHtml = `
    ...
    test('should handle GitHub emoji images', () => {
      const html =
    ...
    test('should handle GitHub user mentions', () => {
      const html =
