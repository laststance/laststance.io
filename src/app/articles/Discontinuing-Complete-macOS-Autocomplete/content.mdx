...
export const article = {
  ...
  date: '2026-02-14',
  description:
    'After reaching production-ready status with 156 tests and sub-50ms performance, I am discontinuing Complete — a macOS system-wide spell autocomplete app. The reason: per-application coordinate calculation for the floating completion window proved unsustainably complex.',
}
...
_The source code is available at [github.com/laststance/complete](https://github.com/laststance/complete)_
