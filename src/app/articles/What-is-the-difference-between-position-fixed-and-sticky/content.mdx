...
<div className="rounded-lg border border-gray-200 bg-linear-to-br from-blue-50 to-indigo-50 p-8 text-center dark:border-gray-700 dark:from-gray-800 dark:to-gray-900">
  <div className="mb-4">
    <svg
