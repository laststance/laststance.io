...
export type KeybindsList = {
  [category: string]: Record<string, string | Record<string, string>>
}
...
const keybinds: KeybindsList = {
  ...
  Editor: {
    ...
    'IDE Feature': {
      ...
      'Reload Window': '^-x ^-r',
      'Open Settings': 'CMD ,',
      'Keybind Settings': 'Shift CMD ,',
      'Open Cursor Settings': 'Shift CMD N',
      'ESLint  —fix': '^-x ^-x',
      'Format with Prettier': '^ Space',
