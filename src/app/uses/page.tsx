    ...
    >
      <div className="space-y-20">
        <ToolsSection title="Hardware">
          <Tool
            title={
              '16" MacBook Pro M4 Max (16-core CPU, 40-core GPU, 64GB RAM) (2024)'
            }
            href="https://support.apple.com/en-us/121554"
          >
            Finally upgraded to the latest Apple Silicon M4 Max with 16-core CPU
            and 40-core GPU. The leap from Intel i7 to M4 Max is absolutely
            night and day—compilation times are ~10x faster, and Cursor AI
            assistant now runs smoothly without any performance concerns. The
            Liquid Retina XDR display with ProMotion (up to 120Hz) makes
            scrolling incredibly smooth. <br /> The 64GB unified memory is
            substantial enough for heavy workloads like Next.js builds, Docker
            containers, and multiple editor instances simultaneously.
            Thunderbolt 5 connectivity future-proofs the machine. <br /> I
            continue using clamshell mode with an external 1440p monitor, Magic
            Keyboard, and Magic Trackpad to maintain ergonomics—the M4 Max's
            thermal efficiency keeps the machine silent even under load.
          </Tool>
          <Tool
