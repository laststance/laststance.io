...
describe('OG Route - sanitizeTitle', () => {
  describe('default behavior', () => {
    test('should return default title for null input', () => {
      expect(sanitizeTitle(null)).toBe(DEFAULT_TITLE)
    })

    test('should return default title for empty string', () => {
      expect(sanitizeTitle('')).toBe(DEFAULT_TITLE)
    })

    test('should return valid title unchanged', () => {
  ...
  describe('XSS prevention', () => {
    ...
    test('should remove data: case insensitive', () => {
      expect(sanitizeTitle('DATA:text/html')).toBe('text/html')
    })

    test('should handle multiple injection attempts', () => {
  ...
  describe('whitespace handling', () => {
    ...
    test('should return default for whitespace-only input', () => {
      expect(sanitizeTitle('   ')).toBe(DEFAULT_TITLE)
    })
  })

  describe('edge cases', () => {
    test('should handle title with only removed characters', () => {
      expect(sanitizeTitle('<>')).toBe(DEFAULT_TITLE)
    })
    ...
    test('should handle URL-encoded content (not decoded)', () => {
    ...
    test('should handle quotes safely', () => {
  ...
  describe('real-world blog post titles', () => {
    test('should handle technical titles', () => {
      expect(sanitizeTitle('Building a REST API with Node.js')).toBe(
        'Building a REST API with Node.js',
      )
    })

    test('should handle titles with symbols', () => {
